...
- [Winner Takes All](./main.html?file=winner-takes-all-cld&menu=true) — see the [Winner Takes All article](https://dmccreary.github.io/tracking-ai-course/articles/winner-takes-all/) for the full discussion.
